                    ...
                    <div className="mx-auto   2xl:max-w-[70%] px-4 lg:px-8 ">
                        ...
                        <span className="text-md font-bold text-gray-500">
                           تعمیر تلویزیون ایکس ویژن جنوب تهران در مجموعه   سرویس، تی وی  آماده ارائه خدمات تعمیر تلویزیون، نصب و راه اندازی آن را دارد.
                                    ...
                                    <div className="my-10">
                                        <h2 className="text-2xl font-bold text-sky-600">تعمیر تلویزیون ایکس ویژن جنوب
                                            تهران</h2>
                                        <p className="text-lg font-bold text-gray-500">در صورت بروز هر مشکلی در تلویزیون
                                            خود، اعم از مشکلات مربوط به تصویر، صدا و پنل تلویزیون می توانید با ما تماس
                                            بگیرید و درخواست خود را برای اعزام کارشناسان مربوطه به محل را ثبت کنید</p>
                                    </div>
                                    <div className="my-10">
                                        <h2 className="text-2xl font-bold text-sky-600">تعمیر تلویزیون ایکس ویژن جنوب
                                            تهران</h2>
