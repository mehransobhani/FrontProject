                    ...
                    <h1 className="text-gray-800 font-lg font-bold tracking-normal leading-tight mb-4">ویرایش کلمه عبور</h1>
                        ...
                        <div className="flex items-center justify-start w-full">
                            <button onClick={changePasswordHandle}
                                    className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm">ویرایش
                            </button>
                            <button
