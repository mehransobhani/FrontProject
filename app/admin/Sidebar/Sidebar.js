...
export default function Sidebar() {
    ...
    return (<>
        <nav
            className="md:right-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-[#445861]  flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
            <div
                ...
                >
                    ...
                    <div className={"mt-2"}>
                        <Link href={"/admin/brands"}>
                            <div
                                className={["flex items-center p-2  rounded-lg  text-white hover:bg-gray-700 group",  pathname == "/admin/baners" ?"bg-gray-700":"" ].join(" ")}>
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 18 18">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">بنر ها</span>
                            </div>
                        </Link>
                    </div>
                    <div className={"mt-2"}>
