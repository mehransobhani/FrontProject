export  default  async  function Pagination(props:{hasMore:boolean,page:number,nextPage:any,previousPage:any,nextPage2:any,previousPage2:any,totalPage:number})
{
    return(<>
            ...
            <ul className="flex items-center -space-x-px h-8 text-sm m-5">
                ...
                { 1 <= props.page-2 &&<li>
                    <div aria-current="page"
                         onClick={props.previousPage2}
                         className="flex cursor-pointer items-center justify-center px-3 h-8 leading-tight text-white bg-indigo-500 border border-gray-300 hover:bg-indigo-400  ">{props.page-2}</div>
                </li>}
                { 1 <= props.page-1 &&<li>
                    <div aria-current="page"
                         onClick={props.previousPage}

                         className="flex cursor-pointer items-center justify-center px-3 h-8 leading-tight text-white bg-indigo-500 border border-gray-300 hover:bg-indigo-400 ">{props.page-1}</div>
                </li>}
                <li>
                    <div aria-current="page"
                ...
                { props.totalPage >= props.page+1 &&<li>
                    <div aria-current="page"
                         onClick={props.nextPage}
                         className="flex cursor-pointer items-center justify-center px-3 h-8 leading-tight text-white bg-indigo-500 border border-gray-300 hover:bg-indigo-400 ">{props.page+1}</div>
                </li>}
                { props.totalPage >= props.page+2 &&<li>
                    <div aria-current="page"
                         onClick={props.nextPage2}
                         className="flex cursor-pointer items-center justify-center px-3 h-8 leading-tight text-white bg-indigo-500 border border-gray-300 hover:bg-indigo-400 ">{props.page+2}</div>
                </li>}
                {
                    props.hasMore &&
